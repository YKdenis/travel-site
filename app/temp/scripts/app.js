...
var stickyHeader = new _stickyHeader2.default(".large-hero__title");
...
var RevealOnScroll = function () {
    function RevealOnScroll(itemsToRevealClassName, offset) {
        _classCallCheck(this, RevealOnScroll);

        this.itemsToReveal = (0, _jquery2.default)(itemsToRevealClassName);
        this.hideInitially();
    ...
    _createClass(RevealOnScroll, [{
        ...
        key: 'createWaypoints',
        value: function createWaypoints(itemsToReveal, offsetPercentage) {
...
var StickyHeader = function () {
    function StickyHeader(triggerElementClassName) {
        _classCallCheck(this, StickyHeader);

        this.siteHeader = (0, _jquery2.default)(".site-header");
        this.triggerElement = (0, _jquery2.default)(triggerElementClassName);
    ...
    _createClass(StickyHeader, [{
        ...
        value: function addSmoothScrolling(headerLinks) {
            headerLinks.smoothScroll();
        }
    }, {
        key: 'createHeaderWaypoint',
        value: function createHeaderWaypoint(triggerEl, siteHeader) {
            new Waypoint({
                element: triggerEl[0],
        ...
        value: function createPageSectionWaypoints(pageSections, headerLinks) {
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function openModal() {
            ...
            // prevents default behaviour of scrolling up with '#' in link
            return false;
        }
    }, {
        key: "closeModal",
